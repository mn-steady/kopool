...
describe Matchup do
  ...
  context "matchup complete" do
    ...
    before(:each) do
      ...
      @pool_entry_1 = FactoryGirl.create(:pool_entry, team_name: "We Will Lose Home (tie)", season: @season, user: @user)
      @pool_entry_2 = FactoryGirl.create(:pool_entry, team_name: "We Will Lose Away (tie)", season: @season, user: @user)
      @pool_entry_3 = FactoryGirl.create(:pool_entry, team_name: "We Will Win (Home)", season: @season, user: @user)
      @pool_entry_4 = FactoryGirl.create(:pool_entry, team_name: "We Will Lose (Away)", season: @season, user: @user)

      @pick1 = FactoryGirl.create(:pick, pool_entry: @pool_entry_1, week: @week16, nfl_team: @monday_matchup.home_team, matchup: @monday_matchup)
      @pick2 = FactoryGirl.create(:pick, pool_entry: @pool_entry_2, week: @week16, nfl_team: @monday_matchup.away_team, matchup: @monday_matchup)
      @pick3 = FactoryGirl.create(:pick, pool_entry: @pool_entry_3, week: @week16, nfl_team: @thursday_matchup.home_team, matchup: @thursday_matchup)
      @pick4 = FactoryGirl.create(:pick, pool_entry: @pool_entry_4, week: @week16, nfl_team: @thursday_matchup.away_team, matchup: @thursday_matchup)
