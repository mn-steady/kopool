class Pick < ApplicationRecord
  ...
  validates :team_id, :week_id, :matchup_id, presence: true
  validates :pool_entry_id, presence: true, uniqueness: { scope: :week_id }
